...
/* - Pronounced as the name "Ivo", in honour of my dad. Tzvetanka-variant in honour of my mom... :) */

// WARNING: UNDOCUMENTED VARIANT - as opposed to general 1V0, this works
// not as A = A op B, but as C = A op B! Study the code, unless you have
// received a specific (typewritten) instruction leaflet
...
//SoftwareSerial SRL(-1,3);
SoftwareSerial SRL(1,0);
//^^^^^^^^^^^^^^^^^^
...
/*
    ...
    if (analogbutton < 20) {
      ...
      rd = 14;
    } else if (analogbutton < 690 ) {
      rd = 12;
    } else if (analogbutton < 780 ) {
      rd = 13;
    } else if (analogbutton < 825 ) {
      rd = 10;
    } else if (analogbutton < 860 ) {
      rd = 1;
    } else if (analogbutton < 882 ) {
      rd = 2;
    } else if (analogbutton < 900 ) {
      rd = 3;
    } else if (analogbutton < 915 ) {
      rd = 4;
    } else if (analogbutton < 925 ) {
      rd = 5;
    } else if (analogbutton < 934 ) {
      rd = 6;
    } else if (analogbutton < 941 ) {
      rd = 7;
    } else if (analogbutton < 948 ) {
      rd = 8;
    } else if (analogbutton < 954) {
      rd = 9;
    } else if (analogbutton < 958) { // 956 is the 15th button
      rd = 0;
    } else {
      rd = 0;
    }
...
runlimit = 9999; /* set it with -9, 0 means infinite. */
...
//    Serial.print(F(" "));
    SRL.print(-((long) ((instr >> 27) & 31)));
//    Serial.print(F(" "));
    SRL.print(-((long) ((instr >> 18) & 511)));
//    Serial.print(F(" "));
    SRL.print(-((int) ((instr >> 9) & 511))); // if this and below are long, the sketch is too big!
//    Serial.print(F(" "));
    SRL.print(-((int) (instr & 511)));

    SRL.print(F(" ")); delay(500); tabula++; if (tabula == 4) { tabula = 0; SRL.println(); delay(1990); }
  }
  SRL.println(); tabula = 0;
  ...
  for (i = 1; i < DATAMEM; i++) {
    SRL.print(datum[i]);
    SRL.print(-i);
    SRL.write(" "); tabula++; delay(500); if (tabula == 8) { tabula = 0; SRL.println(); delay(2000); } // F(" ") produced J
  }
  SRL.println(); tabula = 0;
...
while (pc < EXECMEM) {
  ...
  SRL.print(F(" ")); tabula++; delay(500); if (tabula == 4) { tabula = 0; SRL.println(); delay(1990); }
